...
public class Book {
	...
	public Book(String title, String genre, XMLGregorianCalendar date, ArrayList<Author> authors) {
		this.title = title;
		this.genre = genre;
		this.date = date;
		this.authors = new Book.Authors(authors);
	}
    ...
    public static class Authors {
		...
		public Authors(ArrayList<Author> author) {
			this.author = author;
		}
